...
/** Staking operations (Cardano, TON). */
interface IStakingManager {
    ...
    /** Unstake with pool address — required for TON liquid staking (Tonstakers, Bemo). */
    suspend fun unstake(amount: Long, poolAddress: String, coinNetwork: CoinNetwork): TransferResponseModel {
        // Default: delegate to no-pool version for chains that don't need poolAddress
        return unstake(amount, coinNetwork)
    }
