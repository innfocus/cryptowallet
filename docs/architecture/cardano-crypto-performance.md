...
### Phase 1 (1-2 ngày) — Cache master key & account key ← **tài liệu này**
1. Cache master key + account key trong `CardanoManager`
2. Cache wordMap trong `IcarusKeyDerivation`
3. **Kỳ vọng: giảm ~50% thời gian (4s → 2s lần đầu, <1ms lần sau)**
